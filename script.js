const inputTexto1 = document.querySelector(".card-textarea");
const mensagem = document.querySelector(".card-textarea-area2");
...
function copiar(){
    var textoCopy = document.querySelector(".card-textarea-area2");
    textoCopy.select();
